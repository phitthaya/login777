            ...
            try:
                ...
                if msg.toType == 0 or msg.toType == 1 or msg.toType == 2:
                    ...
                    if text.lower() == "ออกจากระบบ":
                              if sender in wait['msg.text.lower()']:
                                
                                contact = client.getContact(msg.text.lower())
                                os.system('screen -S {} -X quit')
                                os.system('rm -rf {}')
                                if msg.toType == 2:
