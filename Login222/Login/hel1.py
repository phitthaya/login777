...
creator = ['u900d5beca481af9f49816397fa047ced']
adminbots = ['u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']
...
def backupData():
    try:
        ...
        client.sendMessage("u900d5beca481af9f49816397fa047ced",str(e))
        return False
                ...
                if msg.toType == 0 or msg.toType == 1 or msg.toType == 2:
                    ...
                    if msg.contentType == 0:
                        if text is None:
                            ...
                            if text.lower() == "." and sender in ['u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']:
                            ...
                            if text.lower().startswith('# ') and sender in ['u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']:
                            ...
                            if text.lower() == "รี" and sender in ['u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']:
                                try:
                            ...
                            if text.lower().startswith('เพิ่ม ') and sender in ['u900d5beca481af9f49816397fa047ced','u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']:
                            ...
                            if text.lower().startswith('ลบ') and sender in ['u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']:
                                sep = text.split(" ")
                            ...
                            if text.lower() == 'สมาชิก' and sender in ['u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']:
                            ...
                            if text.lower() == 'ลบทั้งหมด':
                                if msg._from in ['u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']:
                                    h = ''
                                    no=0
                                    for a in wait['info']:
                                        us = wait["info"][a]
                            ...
                            if text.lower() == "ล็อคอิน":
                                ...
                                if sender in wait['info']:
                                    ...
                                    sendMention(to, ' 「 Error 」\nHi @!\nไม่พบรายชื่อคุณในระบบ\nโปรดติดต่อแอดมิน @! ', [sender, "u900d5beca481af9f49816397fa047ced"])
                            ...
                            if text.lower() == 'addme' and sender in ['u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']:
                                try:
                            ...
                            if text.lower() == "บอทออก" and sender in ['u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']:
                                client.leaveGroup(to)

                            if text.lower().startswith('ต่ออายุ ') and sender in ['u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']:
                                if 'MENTION' in msg.contentMetadata.keys()!= None:
                                    key = eval(msg.contentMetadata["MENTION"])
                                    key1 = key["MENTIONEES"][0]["M"]
                                    if key1 in wait['info']:
                            ...
                            if text.lower().startswith('ต่ออายุ2 ') and sender in ['u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']:
                                if 'MENTION' in msg.contentMetadata.keys()!= None:
                                    key = eval(msg.contentMetadata["MENTION"])
                                    key1 = key["MENTIONEES"][0]["M"]
                                    if key1 in wait['info']:
                            ...
                            if text.lower().startswith('ต่ออายุ 3') and sender in ['u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']:
                                if 'MENTION' in msg.contentMetadata.keys()!= None:
                                    key = eval(msg.contentMetadata["MENTION"])
                                    key1 = key["MENTIONEES"][0]["M"]
                                    if key1 in wait['info']:
                            ...
                            if text.lower().startswith('ต่ออายุแอดมิน ') and sender in ['u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']:
                                if 'MENTION' in msg.contentMetadata.keys()!= None:
                                    key = eval(msg.contentMetadata["MENTION"])
                                    key1 = key["MENTIONEES"][0]["M"]
                                    if key1 in wait['info']:
                            ...
                            if text.lower() == "login me2" and sender in ['u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']:
                                client.generateReplyMessage(msg.id)
                                if sender in wait['info']:
                                        us = wait["info"][sender]
                                        ti = wait['name'][us]["pay"]-time.time()
                            ...
                            if text.lower() == "login me3" and sender in ['u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']:
                                client.generateReplyMessage(msg.id)
                                if sender in wait['info']:
                                        us = wait["info"][sender]
                                        ti = wait['name'][us]["pay"]-time.time()
                                    ...
                                    sendMention(to, ' 「 Error 」\nHi @!\nไม่พบรายชื่อคุณในระบบ\nโปรดติดต่อแอดมิน @! ', [sender, "u7117c2d956015d8cd118f15754164354"])
                            if cmd == 'runtime'and sender in ['u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']:
                                runtime = time.time() - programStart
                                client.sendMessage(to,format_timespan(runtime))
                            if cmd == 'Jam on'and sender in ['u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']:
                                if xxxs["clock"] == True:
                            ...
                            if cmd == 'Jam off'and sender in ['u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']:
                                if xxxs["clock"] == False:
                                    client.sendMessage(msg.to,"already off")
                                else:
                                    xxxs["clock"] = False
                                    client.sendMessage(msg.to,"done")
                            if cmd == 'up'and sender in ['u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']:
                                if xxxs["clock"] == True:
                                    now2 = datetime.now()
                            ...
                            if cmd == 'grouplist'and sender in ['u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']:
                            ...
                            if text.lower() == 'rname'and sender in ['u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']:
                                sendMention(to, "@!", [clientMid])

                            if cmd.startswith('joinme '):
                              if sender in ["u900d5beca481af9f49816397fa047ced"]:
                               text = msg.text.split()
                               number = text[1]
                               if number.isdigit():
                            ...
                            if cmd.startswith('invme '):
                              if sender in ["u900d5beca481af9f49816397fa047ced","u7117c2d956015d8cd118f15754164354"]:
                                cond = cmd.split(" ")
                                num = int(cond[1])
                            ...
                            if cmd.startswith('unsend') and sender in ['u900d5beca481af9f49816397fa047ced','u7117c2d956015d8cd118f15754164354']:
                                try:
                                    args = text.split(' ')
                                    mes = 0
                                    try:
...
#                                    client.sendMessage(to, '「 Unsend 」\nUnsend {} Message'.format(len(MId)))
                ...
                e = traceback.format_exc()
                client.sendMessage("u900d5beca481af9f49816397fa047ced","u7117c2d956015d8cd118f15754164354",str(e))
    except:
        e = traceback.format_exc()
        client.sendMessage("u900d5beca481af9f49816397fa047ced",str(e))
